...
class GuiUpdateRunnerTests(unittest.TestCase):
    ...
    def test_gui_update_runner_can_queue_verified_release_zip_request(self):
        ...
        result = service.run_gui_update(
            "RUN_UPDATE",
            "v0.2.99",
            "https://github.com/C-OneThirty7/TAKlite/releases/download/v0.2.99/TAKlite-v0.2.99.zip",
            "a" * 64,
        )
        ...
        self.assertEqual(request["release_zip_url"], "https://github.com/C-OneThirty7/TAKlite/releases/download/v0.2.99/TAKlite-v0.2.99.zip")
    ...
    def test_update_status_reports_check_failure_without_running_update(self):
        ...
        self.assertEqual(status["current_tag"], "v0.2.21")
    ...
    def test_update_status_extracts_verified_release_zip_asset(self):
        ...
        payload = {
            "tag_name": "v0.2.99",
            "html_url": "https://github.com/C-OneThirty7/TAKlite/releases/tag/v0.2.99",
            "assets": [{
                "name": "TAKlite-v0.2.99.zip",
                "browser_download_url": "https://github.com/C-OneThirty7/TAKlite/releases/download/v0.2.99/TAKlite-v0.2.99.zip",
        ...
        self.assertEqual(status["verified_asset"]["url"], "https://github.com/C-OneThirty7/TAKlite/releases/download/v0.2.99/TAKlite-v0.2.99.zip")
