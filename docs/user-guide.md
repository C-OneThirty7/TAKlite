...
rm -rf /root/taklite
git clone https://github.com/C-OneThirty7/TAKlite.git /root/taklite
cd /root/taklite
...
git clone https://github.com/C-OneThirty7/TAKlite.git /root/TAKlite-update
...
git clone --branch vX.Y.Z --depth 1 \
  https://github.com/C-OneThirty7/TAKlite.git \
  /root/TAKlite-update
...
cd /root
rm -rf /root/TAKlite-update
git clone --depth 1 https://github.com/C-OneThirty7/TAKlite.git /root/TAKlite-update
